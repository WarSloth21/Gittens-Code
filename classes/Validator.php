...
class Validator
{
    ...
    protected $registered_validators = ['natl_id'     => 'isIdValid',
                                        ...
                                        'addr'     => 'isAddressValid',
                                        'parish'    => null,
                                        'cover_note_file'   => null,
                                        'license_image_file'    => 'isLicenseUpValid',
                                        'add_driver'  =>  null,
                                        'cancel_add'  =>  null,
                                        'add_license_img'   =>  null,
                                        'psw'  =>   'isPasswordValid',
                                        'login' => null,
    ...
    protected function isLicenseUpValid (string $imgname)
    {
        $statusMsg = '';
        ...
        if(isset($_POST["submit"]) && !empty($_FILES["fileimg"]["name"])){
            // Allow certain file formats
            $allowTypes = array('jpg','png','jpeg','gif','pdf');
            if(in_array($fileType, $allowTypes)){
                // Upload file to server
                if(move_uploaded_file($_FILES["fileimg"]["tmp_name"], $targetFilePath)){
